...
def make_image_card(FSA,potential,vulnerable,high_risk,total,need,self_iso):
    ...
    if need == "financialSupport":
        d.append(draw.Text("Financial",20,110,85,center=True,fill="#000000",font_weight="bold"))
        d.append(draw.Text("Support",20,110,55,center=True,fill="#000000",font_weight="bold"))
        d.append(draw.Image(175,40,60,60,path="museum.png"))
    elif need == "emotionalSupport":
        d.append(draw.Text("Emotional",20,110,90,center=True,fill="#000000",font_weight="bold"))
        d.append(draw.Text("Support",20,110,60,center=True,fill="#000000",font_weight="bold"))
        d.append(draw.Image(180,45,50,50,path="heart.png"))
    elif need == "medication":
        d.append(draw.Text("Medication",20,110,75,center=True,fill="#000000",font_weight="bold"))
        d.append(draw.Image(190,40,60,60,path="drug.png"))
    elif need == "food":
        d.append(draw.Text("Food/",20,110,105,center=True,fill="#000000",font_weight="bold"))
        d.append(draw.Text("Necessary",20,110,75,center=True,fill="#000000",font_weight="bold"))
        d.append(draw.Text("Resources",20,110,45,center=True,fill="#000000",font_weight="bold"))
        d.append(draw.Image(190,45,50,50,path="food.png"))
    else:
        d.append(draw.Text(need,20,110,75,center=True,fill="#000000",font_weight="bold"))

    d.append(draw.Text("Individuals in Self Isolation",12,450,145,center=True,fill="#000000",font_weight="bold"))
    d.append(draw.Text(str(self_iso*100//total)+"%",40,410,75,center=True,fill="#000000"))
    d.append(draw.Image(470,40,60,60,path="home.png"))
